...
namespace DoctrineORMModule\Proxy\__CG__\Dados\V1\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Enderecos extends \Dados\V1\Entity\Enderecos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'idendereco', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'rua', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'cidade', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'estado', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'numero', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'bairro', '' . "\0" . 'Dados\\V1\\Entity\\Enderecos' . "\0" . 'complemento'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Enderecos $proxy) {
